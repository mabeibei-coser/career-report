...
export const negotiationMock: NegotiationTips = {
  aiExperience: {
    summary:
      "越来越多校招 JD 把「AI 应用经验」列为加分项——面试官真正关心的是你能不能讲清楚哪几个场景把 AI 用明白了。有真实成果的候选人在 offer 谈判里一般能撬动 10-20% 的薪资空间。准备方式：熟练 2-3 个主流工具链（Claude / Cursor / LangChain 等）、1 个由你主导且有量化结果的案例、能当面说出模型能力边界（哪 60% 交给 AI、哪 40% 人工兜底）。",
  },
  internshipExperience: {
    summary:
      "HR 更关注实习里你用 AI 做出了什么，而不是单纯看实习公司的牌子。一段能讲清楚「用了哪个 AI 工具 / 切入哪个工作流 / 节省多少时间或提升多少指标」的实习，是谈薪环节最硬的锚点。准备方式：把 1 段 AI 相关实习打磨成 STAR 故事，成果沉淀到 GitHub / 飞书 / 作品集可扫码查看，面试时和薪资期望一起抛出。",
  },
};
...
export const workplaceInsightMock: WorkplaceInsight = {
  industryAdvice: {
    summary:
      "互联网与科技行业整体告别纯增长时代，进入效率与差异化驱动阶段：AI 应用层岗位 2024-2025 年持续扩张，产品/运营/设计 JD 里「Prompt 工程」「LLM 应用」关键词出现频率比 2024 年翻倍；toB/SaaS 相对稳定适合深耕业务，但成果周期长；出海与跨境业务（TikTok/SHEIN 等）是结构性新增路径，语言能力加分明显；一线核心岗位仍集中北上深杭四城，优先投一线总部岗。",
  },
  companyInsight: {
    targetLabel: "互联网大厂",
    developmentSummary:
